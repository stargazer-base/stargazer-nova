...
export class VideoSearchComponent implements OnInit {
  ...
  searchVideos(
    ...
    const apiUrl = `https://stargazer-base.onrender.com/api/videos?type=${type}&keyword=${keyword}&page=${page}&limit=40`;
  ...
  applyTags() {
    ...
    const apiUrl = 'https://stargazer-base.onrender.com/api/videos/tags';
    const payload = {
